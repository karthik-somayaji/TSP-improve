...
class Lee:
    ...
    def route_all(self, lst, act_lst, alg='bfs'):
...
class router():
    ...
    def examples(self, type_fn):
        ...
        coords = {}
        temp = [ {a1:[(a2,a3), (a4,a5)]} for (a1, (a2,a3), (a4,a5)) in lst]
        for d in temp:
            coords.update(d)
        ...
        if('syn' in type_fn):
            n = int(type_fn[6:])
            self.lst = [(str(i), ((i%2 + 1), (i*2-1 if i%2 else i*2)), ((0 if (i%2) else 3), (i*2-1 if i%2 else i*2)+2 ) ) for i in range(n)]
