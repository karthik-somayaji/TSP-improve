...
class Lee:
    ...
    def route_all(self, lst, act_list, alg='astar'):
        ...
        for nm, src, tgt in act_list:
            self.obstacles.remove(src)
            self.obstacles.remove(tgt)

            path_s, path_l = fn( nm, src, tgt, obstacles=self.obstacles)
